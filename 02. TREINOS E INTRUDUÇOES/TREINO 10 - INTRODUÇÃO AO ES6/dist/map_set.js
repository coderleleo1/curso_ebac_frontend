...
try {
  for (_iterator.s(); !(_step = _iterator.n()).done;) {
    ...
    // comando .keys para recuperar as chaves que um map tem 
    console.log(chave);
  }
} catch (err) {
  _iterator.e(err);
...
try {
  for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
    ...
    // .value para recuperar os valores do map
    console.log(valor);
  }
} catch (err) {
  _iterator2.e(err);
...
var array = ['Jose Paulo', 'Gian Souza', 'Maria Eduarda', 'Luana', 'Luana', 'Gian Souza', 'Luana'];
var arrayComoSet = new Set([].concat(array)); // o SET não permite itens duplicados, com isso, ele removeu os valores que estavam duplicados pelo array acima
