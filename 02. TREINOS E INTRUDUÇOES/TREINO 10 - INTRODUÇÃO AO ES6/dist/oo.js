...
var Pokemon = /*#__PURE__*/function () {
  function Pokemon(nomeDoPokemon, tipoDoPokemon) {
    ...
    // torna a propriedade privada, sendo apenas acessível dentro da classe
  ...
  return _createClass(Pokemon, [{
    ...
    value: function atacar(nomeDoAtaque) {
      console.log("".concat(this.nome, " atacou com o ataque ").concat(nomeDoAtaque));
    }
  }, {
    key: "recebeuAtaque",
